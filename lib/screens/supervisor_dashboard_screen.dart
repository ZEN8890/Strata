// Path: lib/screens/supervisor_dashboard_screen.dart
...
class _SupervisorDashboardScreenState extends State<SupervisorDashboardScreen> {
  ...
  // Daftar halaman untuk Supervisor, tanpa halaman Manajemen Pengguna
  ...
  Future<void> _loadDrawerUserData() async {
    ...
    if (currentUser == null) {
      ...
      log('Error: No user logged in for supervisor dashboard drawer.');
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dashboard Supervisor Strata Lite'),
      ),
      drawer: Drawer(
        child: ListView(
